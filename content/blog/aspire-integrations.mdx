...
pubDate: 2025-12-03
heroImage: '../../src/assets/blogs/aspire-integrations/aspire-hero.webp'
---
...
but sometimes you need one that doesn't exist, and this week I ended up opening my (first) PR to the
[Aspire CommunityToolkit](https://github.com/CommunityToolkit/Aspire) which is where 3rd party integrations with Aspire live.
My [pull request](https://github.com/CommunityToolkit/Aspire/pull/1021) adds integration for [Zitadel](https://zitadel.com)
which is an OpenId Connect compatible identity service with some very interesting free options and self-hosting
(I'm still salty about IdentityServer).

While I was waiting for my PR to merge I already got started on writing my second integration for [Permify](https://permify.co/),
more on that when we get into the code. Let's first take a look at how Aspire handles it's integrations under the hood and
then how we can write our own.
...
is integrated and you don't need to write this yourself 😊
